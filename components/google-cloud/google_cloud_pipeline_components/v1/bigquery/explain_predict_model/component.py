...
def bigquery_explain_predict_model_job(
  ...
  """Launch a BigQuery explain predict model job and waits for it to finish.
    ...
    Args:
        project (str): Required. Project to run BigQuery model prediction job.
        location (Optional[str]): Location to run the BigQuery model prediction
          job. If not set, default to `US` multi-region. For more details, see
          https://cloud.google.com/bigquery/docs/locations#specifying_your_location
        model (google.BQMLModel): Required. BigQuery ML model for explaining
        ...
        top_k_features (Optional[int]): This argument specifies how many top
        ...
        threshold (Optional[float]): A custom threshold for the binary logistic
        ...
        num_integral_steps (Optional[int]): This argument specifies the number
