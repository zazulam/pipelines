...
def bigquery_detect_anomalies_job(
  ...
  """Launch a BigQuery detect anomalies model job and waits for it to finish.
    ...
    Args:
        ...
        model (google.BQMLModel): Required. BigQuery ML model for prediction.
        ...
        table_name (Optional[str]): BigQuery table id of the input table that
          contains the data. For more details, see
        ...
        contamination (Optional[float]): Contamination is the proportion of
          anomalies in the training dataset that are used to create the
