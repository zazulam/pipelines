...
[**pipeline_service_update_pipeline_version**](PipelineServiceApi.md#pipeline_service_update_pipeline_version) | **PATCH** /apis/v2beta1/pipelines/{pipeline_version.pipeline_id}/versions/{pipeline_version.pipeline_version_id} | Updates a pipeline version&#39;s mutable fields (display_name, tags).
...
> V2beta1Pipeline pipeline_service_update_pipeline(pipeline_pipeline_id, pipeline)
...
pipeline = kfp.server_api.InlineObject() # InlineObject | 
    ...
    try:
        # Updates a pipeline's mutable fields (display_name, tags).
        api_response = api_instance.pipeline_service_update_pipeline(pipeline_pipeline_id, pipeline)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling PipelineServiceApi->pipeline_service_update_pipeline: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pipeline_pipeline_id** | **str**| Output. Unique pipeline ID. Generated by API server. | 
 **pipeline** | [**InlineObject**](InlineObject.md)|  | 
...
> V2beta1PipelineVersion pipeline_service_update_pipeline_version(pipeline_version_pipeline_id, pipeline_version_pipeline_version_id, pipeline_version)
...
pipeline_version = kfp.server_api.InlineObject1() # InlineObject1 | 
    ...
    try:
        # Updates a pipeline version's mutable fields (display_name, tags).
        api_response = api_instance.pipeline_service_update_pipeline_version(pipeline_version_pipeline_id, pipeline_version_pipeline_version_id, pipeline_version)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling PipelineServiceApi->pipeline_service_update_pipeline_version: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pipeline_version_pipeline_id** | **str**| Required input field. Unique ID of the parent pipeline. This is ignored in CreatePipelineAndVersion API. | 
 **pipeline_version_pipeline_version_id** | **str**| Output. Unique pipeline version ID. Generated by API server. | 
 **pipeline_version** | [**InlineObject1**](InlineObject1.md)|  | 
