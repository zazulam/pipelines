...
class TestEnsureChannelInputPropagation:
    ...
    def test_pipeline_param_added_to_channel_inputs(self):
        """When a PipelineParameterChannel is passed as secret_name, it should
        be appended to the task's channel_inputs."""
    ...
    def test_duplicate_pipeline_param_not_added_twice(self):
        ...
        use_secret_as_env and use_secret_as_volume, channel_inputs should not
        contain duplicates."""
    ...
    def test_string_input_does_not_add_channel_inputs(self):
        """When a literal string is passed, channel_inputs should not be
        modified."""
    ...
    def test_task_output_added_to_channel_inputs(self):
        """When a task output PipelineChannel is passed as secret_name, it
        should be appended to channel_inputs."""
