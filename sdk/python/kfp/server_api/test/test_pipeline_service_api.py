...
from kfp_server_api.api.pipeline_service_api import \
    PipelineServiceApi  # noqa: E501
...
class TestPipelineServiceApi(unittest.TestCase):
    ...
    def test_pipeline_service_create_pipeline_and_version(self):
        ...
        Creates a new pipeline and a new pipeline version in a single
    ...
    def test_pipeline_service_create_pipeline_version(self):
        ...
        Adds a pipeline version to the specified pipeline ID.  # noqa:
        E501
        """
        pass
    ...
    def test_pipeline_service_delete_pipeline(self):
        ...
        returns an error if the pipeline has any versions. If cascade is
        true, it will also delete all pipeline versions.  # noqa: E501
        """
        pass
    ...
    def test_pipeline_service_delete_pipeline_version(self):
        ...
        Deletes a specific pipeline version by pipeline version ID and
    ...
    def test_pipeline_service_list_pipeline_versions(self):
        ...
        Lists all pipeline versions of a given pipeline ID.  # noqa:
        E501
        """
        pass
