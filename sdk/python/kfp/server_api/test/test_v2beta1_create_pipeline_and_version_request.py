...
from kfp_server_api.models.v2beta1_create_pipeline_and_version_request import \
...
class TestV2beta1CreatePipelineAndVersionRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        """Test V2beta1CreatePipelineAndVersionRequest include_option is a
        boolean, when False only required params are included, when True both
        required and optional params are included."""
