...
class V2beta1PipelineTaskExecutorDetail(object):
    ...
    @property
    def main_job(self):
        """Gets the main_job of this V2beta1PipelineTaskExecutorDetail.  #
        noqa: E501.

        The name of the job for the main container execution.  # noqa:
        E501

        :return: The main_job of this V2beta1PipelineTaskExecutorDetail.
            # noqa: E501
        :rtype: str
        """
    ...
    def main_job(self, main_job):
        ...
        :param main_job: The main_job of this
            V2beta1PipelineTaskExecutorDetail. # noqa: E501
        :type main_job: str
        """
    ...
    def pre_caching_check_job(self):
        """Gets the pre_caching_check_job of this
        V2beta1PipelineTaskExecutorDetail.  # noqa: E501.
    ...
    def pre_caching_check_job(self, pre_caching_check_job):
        """Sets the pre_caching_check_job of this
    ...
    def failed_main_jobs(self):
        """Gets the failed_main_jobs of this V2beta1PipelineTaskExecutorDetail.

        # noqa: E501.

        The names of the previously failed job for the main container
        executions. The list includes the all attempts in chronological
        order.  # noqa: E501

        :return: The failed_main_jobs of this
            V2beta1PipelineTaskExecutorDetail. # noqa: E501
        :rtype: list[str]
        """
    ...
    def failed_main_jobs(self, failed_main_jobs):
        ...
        :param failed_main_jobs: The failed_main_jobs of this
            V2beta1PipelineTaskExecutorDetail. # noqa: E501
    ...
    def failed_pre_caching_check_jobs(self):
        """Gets the failed_pre_caching_check_jobs of this
        V2beta1PipelineTaskExecutorDetail.  # noqa: E501.
    ...
    def failed_pre_caching_check_jobs(self, failed_pre_caching_check_jobs):
        """Sets the failed_pre_caching_check_jobs of this
        V2beta1PipelineTaskExecutorDetail.
