...
class PipelineServiceApi(object):
    ...
    def pipeline_service_delete_pipeline(self, pipeline_id, **kwargs):  # noqa: E501
        """Deletes a pipeline by ID. If cascade is false (default), it returns
        an error if the pipeline has any versions. If cascade is true, it will
        also delete all pipeline versions.  # noqa: E501.
