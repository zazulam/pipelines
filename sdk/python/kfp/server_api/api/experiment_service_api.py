...
from kfp.server_api.exceptions import ApiTypeError  # noqa: F401
...
class ExperimentServiceApi(object):
    ...
    def experiment_service_archive_experiment(self, experiment_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.experiment_service_archive_experiment(experiment_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.experiment_service_archive_experiment_with_http_info(experiment_id, **kwargs)  # noqa: E501

    def experiment_service_archive_experiment_with_http_info(self, experiment_id, **kwargs):  # noqa: E501
        """Archives an experiment and the experiment's runs and recurring runs.
        ...
        >>> thread = api.experiment_service_archive_experiment_with_http_info(experiment_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    ' to method experiment_service_archive_experiment' % key
                )
        ...
        if self.api_client.client_side_validation and ('experiment_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError('Missing the required parameter `experiment_id` when calling `experiment_service_archive_experiment`')  # noqa: E501
    ...
    def experiment_service_create_experiment_with_http_info(self, experiment, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    ' to method experiment_service_create_experiment' % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def experiment_service_delete_experiment(self, experiment_id, **kwargs):  # noqa: E501
        """Deletes an experiment without deleting the experiment's runs and
        recurring  runs. To avoid unexpected behaviors, delete an experiment's
        runs and recurring  runs before deleting the experiment.  # noqa: E501.

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.experiment_service_delete_experiment(experiment_id, async_req=True)
        >>> result = thread.get()
    ...
    def experiment_service_delete_experiment_with_http_info(self, experiment_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.experiment_service_delete_experiment_with_http_info(experiment_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('experiment_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['experiment_id'] is None):  # noqa: E501
            raise ApiValueError('Missing the required parameter `experiment_id` when calling `experiment_service_delete_experiment`')  # noqa: E501
    ...
    def experiment_service_get_experiment(self, experiment_id, **kwargs):  # noqa: E501
        """Finds a specific experiment by ID.  # noqa: E501.

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.experiment_service_get_experiment(experiment_id, async_req=True)
        >>> result = thread.get()
    ...
    def experiment_service_get_experiment_with_http_info(self, experiment_id, **kwargs):  # noqa: E501
        """Finds a specific experiment by ID.  # noqa: E501.

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.experiment_service_get_experiment_with_http_info(experiment_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('experiment_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['experiment_id'] is None):  # noqa: E501
            raise ApiValueError('Missing the required parameter `experiment_id` when calling `experiment_service_get_experiment`')  # noqa: E501
    ...
    def experiment_service_list_experiments(self, **kwargs):  # noqa: E501
        """Finds all experiments. Supports pagination, and sorting on certain
        fields.  # noqa: E501.

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.experiment_service_list_experiments(async_req=True)
        >>> result = thread.get()
    ...
    def experiment_service_list_experiments_with_http_info(self, **kwargs):  # noqa: E501
        """Finds all experiments. Supports pagination, and sorting on certain
        fields.  # noqa: E501.
        ...
        >>> thread = api.experiment_service_list_experiments_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def experiment_service_unarchive_experiment(self, experiment_id, **kwargs):  # noqa: E501
        """Restores an archived experiment. The experiment's archived runs and
        recurring runs will stay archived.  # noqa: E501.

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.experiment_service_unarchive_experiment(experiment_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.experiment_service_unarchive_experiment_with_http_info(experiment_id, **kwargs)  # noqa: E501

    def experiment_service_unarchive_experiment_with_http_info(self, experiment_id, **kwargs):  # noqa: E501
        """Restores an archived experiment. The experiment's archived runs and
        recurring runs will stay archived.  # noqa: E501.
        ...
        >>> thread = api.experiment_service_unarchive_experiment_with_http_info(experiment_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    ' to method experiment_service_unarchive_experiment' % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'experiment_id' is set
        if self.api_client.client_side_validation and ('experiment_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['experiment_id'] is None):  # noqa: E501
            raise ApiValueError('Missing the required parameter `experiment_id` when calling `experiment_service_unarchive_experiment`')  # noqa: E501
