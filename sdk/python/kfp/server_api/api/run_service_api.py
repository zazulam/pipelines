...
class RunServiceApi(object):
    ...
    def run_service_create_run(self, run, **kwargs):  # noqa: E501
        """Creates a new run in an experiment specified by experiment ID. If
        experiment ID is not specified, the run is created in the default
    ...
    def run_service_list_runs(self, **kwargs):  # noqa: E501
        """Finds all runs in an experiment given by experiment ID. If
        experiment id is not specified, finds all runs across all experiments.
    ...
    def run_service_unarchive_run(self, run_id, **kwargs):  # noqa: E501
        """Restores an archived run in an experiment given by run ID and
