...
class VisualizationServiceApi(object):
    ...
    def visualization_service_create_visualization_v1_with_http_info(self, namespace, visualization, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(V2beta1Visualization, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.api_client.call_api(
            '/apis/v2beta1/visualizations/{namespace}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='V2beta1Visualization',  # noqa: E501
