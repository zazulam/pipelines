...
class RecurringRunServiceApi(object):
    ...
    def recurring_run_service_create_recurring_run(self, recurring_run, **kwargs):  # noqa: E501
        """Creates a new recurring run in an experiment, given the experiment
        ID.  # noqa: E501.
    ...
    def recurring_run_service_disable_recurring_run(self, recurring_run_id, **kwargs):  # noqa: E501
        """Stops a recurring run and all its associated runs. The recurring run
        is not deleted.  # noqa: E501.
    ...
    def recurring_run_service_enable_recurring_run(self, recurring_run_id, **kwargs):  # noqa: E501
        """Restarts a recurring run that was previously stopped. All runs
        associated with the recurring run will continue.  # noqa: E501.
    ...
    def recurring_run_service_list_recurring_runs(self, **kwargs):  # noqa: E501
        """Finds all recurring runs given experiment and namespace. If
        experiment ID is not specified, find all recurring runs across all
