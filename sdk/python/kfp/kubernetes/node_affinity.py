...
def add_node_affinity(
    ...
    <https://kubernetes.io/docs/concepts/scheduling-eviction/assign-pod-node/#node-affinity>`__.

    Each constraint is specified as a match expression (key, operator, values) or match field,
    corresponding to the PodSpec's `nodeAffinity <https://kubernetes.io/docs/reference/kubernetes-api/workload-resources/pod-v1/#NodeAffinity>`__ field.
